...
// Комбинаторика
assign Reset = ~nRES;
assign M2_out = nRES ? M2 : 1'b0;
assign ADDR_BUS[15:0] = nRES ? ADR[15:0] : 16'd0;
assign OUT[2:0]  = nRES ? OUTR[2:0] : 3'b000;
assign nIN[1:0]  = nRES ? { nR4017, nR4016 } : 2'b11;
...
assign  INT_FF = ~( Reset | IRQDIS | ~( PHI1 | nR4015 ));
