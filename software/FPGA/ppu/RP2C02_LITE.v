...
output nINT,        	// Interrupt Request Output
...
input [2:0]A,          // Register address
// Outputs
output reg [7:0]DBIN,  // PPU open bus
...
output reg VSYNC_FF, // vertical synchronization
...
output nINT,         // interrupt on VBLANK
...
always @(posedge Clk) begin
         ...
         if (N_HB) begin
         if (V_LINE1N | V_LINE1P) VSYNC_FF <= 1'b0;
    else if (V_LINE0N | V_LINE0P) VSYNC_FF <= 1'b1;
                    end
         if (~nRES) RC <= 1'b1;
